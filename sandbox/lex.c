...
static yyconst flex_int16_t yy_def[17] =
    {   0,
       15,    1,   16,   16,   16,   16,   16,   16,   16,   16,
       15,   15,   15,   15,    0,   15
    } ;

static yyconst flex_uint16_t yy_nxt[10] =
    {   0,
       12,   13,   14,   12,   15,   11,   15,   15,   15
    } ;

static yyconst flex_int16_t yy_chk[10] =
    {   0,
        1,    1,    1,   16,   11,   15,   15,   15,   15
    } ;
...
case YY_STATE_EOF(_MLCMNT):
case YY_STATE_EOF(_FUNCTION):
case YY_STATE_EOF(_STRING):
case YY_STATE_EOF(_SHELLECHO):
	yyterminate();
