bin/HLang-interpreter:	src/main.c src/variable_mgmt.c src/scope_mgmt.c src/ast.c src/hlang-lexer.l src/hlang-parser.y
	@echo "+------------------------------------+"
	...
	gcc -o $@ src/main.c src/variable_mgmt.c src/scope_mgmt.c src/ast.c build/hlang-parser.c build/hlang-lexer.c -lfl -I headers/ -std=gnu99
